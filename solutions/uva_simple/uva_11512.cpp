...
int countOccurences(string DNA, string repetitions) {
    int count = 0;
    size_t found = DNA.find(repetitions);

    while (found != string::npos) {
        count++;
        found = DNA.find(repetitions, found + 1);
    }
    return count;
}
